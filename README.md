...
The E3C corpus allows for training and evaluation of information extraction systems. To let researchers to compare their models under the same experimental conditions, the three layers of which E3 is made have to be used as following. 
